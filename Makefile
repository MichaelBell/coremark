...
%.o: %.c
	$(CC) -DITERATIONS=0 -DPERFORMANCE_RUN -Os -I$(TINYQV_SDK) -Itinyqv/ -I. -march=rv32ec_zcb -mabi=ilp32e -mno-strict-align -nostdlib -nostartfiles -ffreestanding -ffunction-sections -fdata-sections -Wall -Werror -lc -c $< -o $@
